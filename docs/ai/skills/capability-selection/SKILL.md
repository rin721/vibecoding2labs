...
3. Select the smallest capability groups that satisfy the requirement.
4. Explain why lighter and heavier options were not selected.
5. Ask for hard confirmation before dependency installation or skeleton creation.
6. After confirmation, create a bounded execution slice with validation and
   rollback.
