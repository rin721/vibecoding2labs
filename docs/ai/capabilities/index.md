...
| --- | --- | --- | --- | --- |
| `cap_ui_001` | UI library and design system | `shadcn/ui + Radix UI + Tailwind CSS` | Product UI, dashboards, internal tools, design-system-friendly apps | `docs/ai/capabilities/groups/ui-library.yaml` |
| `cap_arch_001` | Frontend engineering architecture | `React + TypeScript + Vite` with layered app boundaries | Future browser app or local web tool | `docs/ai/capabilities/groups/frontend-architecture.yaml` |
...
| `cap_py_tools_001` | Python engineering tools | `pytest + ruff + typer + pydantic` | Python utilities, CLI tools, validators, AI support scripts | `docs/ai/capabilities/groups/python-tooling.yaml` |
...
3. Record the chosen groups in a decision record.
4. Create a new execution slice with allowed files, dependencies, commands, and rollback plan.
5. Ask for hard confirmation before installing dependencies or creating lockfiles.
